...
namespace MTGCM.Forms
{
    public partial class Block_List : Form
    {
        ...
        private void Odswierz()
        {
            ...
            {
                SQLiteDataAdapter adapter = new SQLiteDataAdapter("SELECT * FROM [Block];", conn);
        ...
        private void EditBlock()
        {
            if (dataGridView1.SelectedRows.Count > 0)
            {
                ...
                Block_Edit objSet_Edit = new Block_Edit(id);
        ...
        private void AddBlock()
        {
            ...
            Block_Add objSet_Add = new Block_Add();
            ...
            if (dataGridView1.SelectedRows.Count > 0)
            {
                ...
                if (result == DialogResult.Yes)
                    using (SQLiteConnection conn = new SQLiteConnection(connString))
                    {
                        ...
                        command.CommandText = "DELETE FROM [Block] WHERE id = @id";
